...
const relatedProducts = [
  { id: "1", name: "Nastar Classic", price: 92000, image: "/Nastar Classic.png", link: "/detailpage1" },
  { id: "2", name: "Putri Salju", price: 86000, image: "/Putri Salju.png", link: "/detailpage3" },
  { id: "3", name: "Lidah Kucing", price: 88000, image: "/Lidah Kucing.png", link: "/detailpage4" },
  { id: "4", name: "Cookies Kacang", price: 80000, image: "/Kue Kacang.png", link: "/detailpage8" },
  { id: "5", name: "Vanila Choco Cookies", price: 72000, image: "/Cookies Vanila & Coklat.png", link: "/detailpage7" },
];
...
export default function DetailPage() {
  ...
  const handleAddToCart = () => {
    ...
    const newProduct = {
      ...
      name: "Nastar Daun",
      price: 97000,
      img: "/nastar daun.png", // Samakan dengan gambar utamanya
      qty: qty
    };
    ...
    // Opsional: Reset qty ke 0 setelah berhasil dimasukkan
    setQty(0);
  };
      ...
      <main className="mx-auto max-w-360 px-6 pt-32 pb-16">
        ...
        <div className="flex flex-col gap-12 lg:flex-row lg:gap-16 mb-10">
          ...
          <div className="-ml-4 -mt-1 flex w-full flex-col justify-start lg:w-[50%] lg:-ml-20">
            <h1 className="mb-4 text-4xl font-bold text-[#111111] md:text-5xl">Nastar Daun</h1>
            <p className="mb-6 text-3xl font-bold text-[#111111]">Rp97.000</p>
            ...
            <div className="mb-6 flex items-center gap-2">
              ...
              <span className="text-sm text-[#666666]">4.9/5 (22 Ulasan)</span>
            </div>

            <p className="mb-6 text-sm font-medium text-[#DC2626]">
              Ketersediaan: Stok Terbatas (Tersisa 20 Toples)
            </p>
            
            <p className="mb-8 text-lg leading-relaxed text-[#666666] text-justify">
              Tampil lebih cantik dan elegan dengan bentuk daun yang memikat. Nastar istimewa ini dibuat menggunakan mentega premium yang membalut isian selai nanas asli hasil olahan sendiri. Motif daunnya yang cantik memberikan sedikit sensasi renyah di bagian luar, namun adonannya tetap empuk dan seketika lumer di mulut saat dikunyah. Menghadirkan perpaduan rasa buttery, manis, dan legit yang pas. 100% tanpa pengawet. Pilihan tepat untuk camilan keluarga dan hari raya!
            </p>
