...
export default function DetailPage() {
  ...
  const handleAddToCart = () => {
    ...
    const newProduct = {
      id: "7", // ID Vanila Choco Cookies
      name: "Vanila Choco Cookies",
      price: 72000,
      img: "/Cookies Vanila & Coklat.png",
      qty: qty
    };
        ...
        <div className="flex flex-col gap-12 lg:flex-row lg:gap-16 mb-10">
          ...
          <div className="flex w-full items-start justify-start lg:w-[51%]">
            <div className="relative group -ml-4 -mt-6 w-full aspect-square overflow-hidden rounded-[20px] bg-[#F5F5F5] shadow-sm transition-shadow duration-300 hover:shadow-xl lg:-ml-12">
              <Image 
                src="/Cookies Vanila & Coklat 2.png" 
                alt="Vanila Choco Cookies" 
                fill 
                priority 
          ...
          <div className="-ml-4 -mt-1 flex w-full flex-col justify-start lg:w-[50%] lg:-ml-20">
            <h1 className="mb-4 text-4xl font-bold text-[#111111] md:text-5xl">Vanila Choco Cookies</h1>
            <p className="mb-6 text-3xl font-bold text-[#111111]">Rp72.000</p>
            ...
            <div className="mb-6 flex items-center gap-2">
              ...
              <span className="text-sm text-[#666666]">4.7/5 (18 Ulasan)</span>
            </div>
            ...
            <p className="mb-8 text-lg leading-relaxed text-[#666666] text-justify">
              Perpaduan sempurna antara aroma vanila yang lembut dan potongan cokelat premium yang lumer. Cookies ini menawarkan tekstur yang renyah namun tetap ringan di setiap gigitan. Dibuat dengan bahan berkualitas tinggi, menghasilkan cita rasa manis yang elegan dan tidak berlebihan. Cocok untuk dinikmati sebagai teman minum teh atau kopi di sore hari.
            </p>
