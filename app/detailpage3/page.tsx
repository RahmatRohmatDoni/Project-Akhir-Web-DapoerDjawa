...
const relatedProducts = [
  ...
  { id: "2", name: "Nastar Daun", price: 97000, image: "/Nastar Daun.png", link: "/detailpage6" },
      ...
      <main className="mx-auto max-w-360 px-6 pt-32 pb-16">
        ...
        <div className="flex flex-col gap-12 lg:flex-row lg:gap-16 mb-10">
          ...
          <div className="-ml-4 -mt-1 flex w-full flex-col justify-start lg:w-[50%] lg:-ml-20">
            <h1 className="mb-4 text-4xl font-bold text-[#111111] md:text-5xl">Putri Salju</h1>
            <p className="mb-6 text-3xl font-bold text-[#111111]">Rp86.000</p>
            ...
            <div className="mb-6 flex items-center gap-2">
              ...
              <span className="text-sm text-[#666666]">4.8/5 (22 Ulasan)</span>
            </div>

            <p className="mb-6 text-sm font-medium text-[#DC2626]">
              Ketersediaan: Stok Terbatas (Tersisa 18 Toples)
            </p>
            
            <p className="mb-8 text-lg leading-relaxed text-[#666666] text-justify">
              Kue kering legendaris dengan balutan gula halus yang menyerupai salju. Teksturnya yang lembut dan lumer saat digigit memberikan sensasi manis yang pas. Dibuat dengan bahan-bahan pilihan berkualitas tinggi untuk menjamin cita rasa autentik dan kelembutan yang tiada duanya. Sempurna untuk disajikan di meja tamu atau sebagai hantaran istimewa.
            </p>
