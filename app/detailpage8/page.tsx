...
const relatedProducts = [
  ...
  { id: "2", name: "Lidah Kucing", price: 88000, image: "/Lidah Kucing.png", link: "/detailpage4" },
  { id: "3", name: "Nastar Classic", price: 92000, image: "/Nastar Classic.png", link: "/detailpage1" },
  { id: "4", name: "Nastar Daun", price: 97000, image: "/Nastar Daun.png", link: "/detailpage6" },
      ...
      <main className="mx-auto max-w-360 px-6 pt-32 pb-16">
        ...
        <div className="flex flex-col gap-12 lg:flex-row lg:gap-16 mb-10">
          ...
          <div className="-ml-4 -mt-1 flex w-full flex-col justify-start lg:w-[50%] lg:-ml-20">
            <h1 className="mb-4 text-4xl font-bold text-[#111111] md:text-5xl">Cookies Kacang</h1>
            <p className="mb-6 text-3xl font-bold text-[#111111]">Rp80.000</p>
            ...
            <div className="mb-6 flex items-center gap-2">
              ...
              <span className="text-sm text-[#666666]">4.8/5 (28 Ulasan)</span>
            </div>
            ...
            <p className="mb-8 text-lg leading-relaxed text-[#666666] text-justify">
              Camilan klasik yang selalu dirindukan! Cookies kacang kami dibuat dengan kacang pilihan berkualitas, memberikan rasa gurih yang dominan dan tekstur yang sangat renyah. Aroma kacang panggang yang harum akan langsung terasa begitu toples dibuka. Dibuat dengan resep tradisional yang otentik, memberikan sensasi nostalgia di setiap gigitan. Camilan sempurna untuk segala suasana.
            </p>
