...
const relatedProducts = [
  { id: "1", name: "Putri Salju", price: 86000, image: "/Putri Salju.png", link: "/detailpage3" },
  { id: "2", name: "Cookies Kacang", price: 80000, image: "/Kue Kacang.png", link: "/detailpage8" },
  { id: "3", name: "Nastar Classic", price: 92000, image: "/Nastar Classic.png", link: "/detailpage1" },
  { id: "4", name: "Vanila Choco Cookies", price: 72000, image: "/Cookies Vanila & Coklat.png", link: "/detailpage7" },
  { id: "5", name: "Choco Chip Cookies", price: 68000, image: "/Choco Chip Cookies.png", link: "/detailpage2" },
];
...
export default function DetailPage() {
  ...
  const handleAddToCart = () => {
    ...
    const newProduct = {
      id: "4", // ID Lidah Kucing
      name: "Lidah Kucing",
      price: 88000,
      img: "/lidah kucing.png", // Samakan dengan gambar utamanya
      qty: qty
    };
      ...
      <main className="mx-auto max-w-360 px-6 pt-32 pb-16">
        ...
        <div className="flex flex-col gap-12 lg:flex-row lg:gap-16 mb-10">
          ...
          <div className="-ml-4 -mt-1 flex w-full flex-col justify-start lg:w-[50%] lg:-ml-20">
            <h1 className="mb-4 text-4xl font-bold text-[#111111] md:text-5xl">Lidah Kucing</h1>
            <p className="mb-6 text-3xl font-bold text-[#111111]">Rp88.000</p>
            ...
            <div className="mb-6 flex items-center gap-2">
              ...
              <span className="text-sm text-[#666666]">4.7/5 (20 Ulasan)</span>
            </div>

            <p className="mb-6 text-sm font-medium text-[#DC2626]">
              Ketersediaan: Stok Terbatas (Tersisa 22 Toples)
            </p>
            
            <p className="mb-8 text-lg leading-relaxed text-[#666666] text-justify">
              Kue kering tipis nan renyah yang siap memanjakan lidah Anda. Dibuat menggunakan paduan mentega premium yang menghasilkan aroma harum dan cita rasa buttery yang gurih. Teksturnya begitu ringan, super garing saat digigit, namun langsung rapuh lembut di mulut. Manisnya pas, tidak bikin enek, dan 100% tanpa bahan pengawet. Pilihan tepat untuk camilan keluarga dan hari raya!
            </p>
