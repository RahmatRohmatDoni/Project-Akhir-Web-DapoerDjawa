...
const relatedProducts = [
  { id: "1", name: "Choco Chip Cookies", price: 68000, image: "/Choco Chip Cookies.png", link: "/detailpage2" },
  { id: "2", name: "Vanila Choco Cookies", price: 72000, image: "/Cookies Vanila & Coklat.png", link: "/detailpage7" },
  { id: "3", name: "Cookies Kacang", price: 80000, image: "/Kue Kacang.png", link: "/detailpage8" },
  { id: "4", name: "Putri Salju", price: 86000, image: "/Putri Salju.png", link: "/detailpage3" },
  { id: "5", name: "Nastar Classic", price: 92000, image: "/Nastar Classic.png", link: "/detailpage1" },
];
...
export default function DetailPage() {
  ...
  // State terpusat untuk kontrol Modal pop-up (Sukses/Error)
  ...
  const handleAddToCart = () => {
    ...
    const newProduct = {
      id: "5", // ID Bola Bola Rambutan Coklat
      name: "Bola Bola Rambutan Coklat",
      price: 85000,
      img: "/bola bola rambutan coklat.png", // Samakan dengan gambar utamanya
      qty: qty
    };

    // 2. Ambil keranjang dari localStorage (kalau belum ada, jadikan array kosong)
    const existingCart = JSON.parse(localStorage.getItem("dapoerdjawa_cart") || "[]");

    // 3. Cek apakah produk ini sudah ada di dalam keranjang
        ...
        <div className="flex flex-col gap-12 lg:flex-row lg:gap-16 mb-10">
          ...
          <div className="flex w-full items-start justify-start lg:w-[51%]">
            <div className="relative group -ml-4 -mt-6 w-full aspect-square overflow-hidden rounded-[20px] bg-[#F5F5F5] shadow-sm transition-shadow duration-300 hover:shadow-xl lg:-ml-12">
              <Image 
                src="/Bola Bola Rambutan Coklat 2.png" 
          ...
          <div className="-ml-4 -mt-1 flex w-full flex-col justify-start lg:w-[50%] lg:-ml-20">
            <h1 className="mb-4 text-4xl font-bold text-[#111111] md:text-5xl">Bola Bola Rambutan Coklat</h1>
            <p className="mb-6 text-3xl font-bold text-[#111111]">Rp85.000</p>
            ...
            <div className="mb-6 flex items-center gap-2">
              ...
              <span className="text-sm text-[#666666]">4.8/5 (25 Ulasan)</span>
            </div>

            <p className="mb-6 text-sm font-medium text-[#DC2626]">
              Ketersediaan: Stok Terbatas (Tersisa 10 Toples)
            </p>
            
            <p className="mb-8 text-lg leading-relaxed text-[#666666] text-justify">
              Suguhan klasik unik yang selalu jadi primadona para pecinta cokelat! Kue istimewa ini dibalut lelehan cokelat pekat premium dan taburan meises melimpah yang memberikan sensasi crunchy di bagian luar. Namun begitu digigit, tekstur bagian dalamnya begitu empuk dan seketika lumer di mulut. Penuh dengan cita rasa cokelat yang intens, manisnya pas, dan 100% tanpa bahan pengawet.Pilihan tepat untuk camilan keluarga dan hari raya!
            </p>
